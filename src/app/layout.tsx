...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        {/* Blue ball */}
        <div className="fixed -z-10 top-0 left-1/2 -translate-x-1/2 w-1/2 h-1/2 rounded-full bg-blue-900 blur-[200px] opacity-40 animate-ball-expand pointer-events-none" />
